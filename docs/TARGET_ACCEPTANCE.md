...
**Обновление расписания:** команда выбрала первый origin
`2026-01-31T23:00:00+05:00` (18:00 UTC), затем ежедневно в 23:00 Asia/Almaty,
первый lead 1 час. [Решение и передача B](FORECAST_SCHEDULE_DECISION.md).
Семантика CSV остаётся неподтверждённой. Ниже сохранена прежняя приёмка и её
диагностические команды: они не являются подтверждением нового расписания.
Модуль A и 58 реальных загрузок описаны отдельно в [DATA_WEATHER.md](DATA_WEATHER.md).
